...
// admins sehen mehr als nutzer
// wenn keine inspection aktiv ist, wird nicht gefiltert
// wenn eine Inspection aktiv ist, wird automatisch beide filter aktiv gefiltert
// 