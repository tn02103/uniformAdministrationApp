...
import { faAddressCard, faBoxOpen, faCircle, faGear, faMitten, faPlus, faShirt, faUser, faUsers } from "@fortawesome/free-solid-svg-icons";
...
export default async function Homepage() {
    ...
    if (!user) return null; // User must be logged in to access this page
    ...
    return (
        <div className="container-lg bg-light rounded p-0 py-4 position-relative">
            ...
            <Row className="g-2 justify-content-evenly">
                ...
                <Col xs={"auto"}>
                    <Link href={"/app/uniform/storage"} prefetch={false}>
                        <div className="card p-1 px-2">
                            <div className="card-title d-flex justify-content-center">
                                <FontAwesomeIcon icon={faBoxOpen} className="fa-4x text-vivid-orange m-2" />
                            </div>
                            <div className="card-text fs-5 text-center">
                                Lager<br />&nbsp;
                            </div>
