...
import { updateReturnChecklistTemplateSchema, UpdateReturnChecklistTemplateInput } from "@/zod/resignationProcess";
...
export const update = (data: UpdateReturnChecklistTemplateInput) =>
    genericSAValidator(
        ...
        prisma.$transaction(async (client) => {
            await client.resignationChecklistItemTemplate.findUniqueOrThrow({
