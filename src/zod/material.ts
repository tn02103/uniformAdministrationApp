...
export const materialGroupFormSchema = z.object({
    description: descriptionSchema.min(1, "string.required").max(20, "string.maxLength;value:20"),
...
export const materialTypeFormSchema = z.object({
    typename: descriptionSchema.min(1, "string.required").max(20, "string.maxLength;value:20"),
